...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-6">
                ...
                <input type="number" name="quantity" id="quantity" class="form-control" value="<?php echo e($product->quantity); ?>" >
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-row my-2">
            <div class="col-4">
                <img src="<?php echo e(asset('images/product/'.$product->image)); ?>" alt="" class="w-50">
...
<?php echo $__env->make('layouts.parent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tasks\dashboard\resources\views/products/edit.blade.php ENDPATH**/ ?>