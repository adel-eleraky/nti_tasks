...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo e(asset('dist/img/AdminLTELogo.png')); ?>" alt="AdminLTELogo" height="60"
                width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?php echo e(asset('dashboard')); ?>" class="brand-link">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="<?php echo e(asset('dashboard')); ?>" class="nav-link ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(asset('dashboard/products')); ?>" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Product</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(asset('dashboard/products/create')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Product</p>
                                    </a>
                                </li>
...
<?php /**PATH C:\xampp\htdocs\tasks\dashboard\resources\views/layouts/parent.blade.php ENDPATH**/ ?>