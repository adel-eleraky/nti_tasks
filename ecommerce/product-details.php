...
$result = $productDetails->setId($_GET['product'])->getProductById()->fetch_all(MYSQLI_ASSOC);

// review table (insert and get)
$review = new review;

if(isset($_POST['submit']) and $_POST['submit'] == "add_review"){
    $review->setProduct_id($_GET['product'])->setUser_id($_SESSION['user']->id)->setRate($_POST['star'])->setComment($_POST['message'])->insertReview();
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="product-details-img">
                    <img class="zoompro" src="assets/img/product-details/<?= $result[0]['image']?>"
